...
<body>
    ...
    <table>
        ...
        while ($row_assigned = $result_assigned->fetch_assoc()) {
            ...
            $tables = array(
                "evaluation_assessment2" => "evaulation_assessment2.php",
                "lesson_presentation2" => "lessonpresent2.php",
                "personalandprofessional2" => "personalandprofessional2.php",
                "classcontrol2" => "classcontrolmanagement2.php",
                "recordkeeping2" => "recordkeeping2.php"
            );
