...
if (isset($_GET["id"])) {
 ...
 if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO classcontrol (student_id, actual_score_introduction, actual_score_pacing, actual_score_teaching_materials, actual_score_teaching_methods)
    ...
    if (!$result) {
        ...
        header("Location: personalandprofessional.php?id=$id");
    }
}
?>
<!DOCTYPE html>
