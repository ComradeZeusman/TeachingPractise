...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO personalandprofessional (student_id, actual_score_introduction, actual_score_pacing, actual_score_teaching_materials)
    ...
    if (!$result) {
        ...
        header("Location: recordkeeping.php?id=$id");
    }
