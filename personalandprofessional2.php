...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO personalandprofessional2 (student_id, actual_score_introduction, actual_score_pacing, actual_score_teaching_materials)
    VALUES ('$id', '$actual_score_introduction', '$actual_score_pacing', '$actual_score_teaching_materials')
    ";
    ...
    if (!$result) {
        ...
        header("Location: recordkeeping2.php?id=$id");
    }
    ...
    <form action="" method="post">
        ...
        <table>
            ...
            <tr>
                ...
                <td>2</td>
                <td><input type="number" name="actual_score_introduction" max="2" required></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Punctuality</td>
                <td>1</td>
                <td><input type="number" name="actual_score_teaching_materials" max="1" required></td>
            </tr>
            </table>
      <!-- Next button -->
