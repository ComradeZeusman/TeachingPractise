...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "INSERT INTO evaluation_assessment2 (student_id, actual_score_introduction, actual_score_pacing, actual_score_teaching_materials, actual_score_teaching_methods, actual_score_questions)
    ...
    if (!$result) {
        ...
        header("Location: classcontrolmanagement2.php?id=$id");
    }
