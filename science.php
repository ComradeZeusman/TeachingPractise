...
$sql = "SELECT * FROM students WHERE program='bachelor of education in sciences'";

if (isset($_POST['search'])) {
    $search = $_POST['search'];
    $sql = "SELECT * FROM students WHERE program='bachelor of education in sciences' AND (first_name LIKE '%$search%' OR last_name LIKE '%$search' OR reg_number LIKE '%$search')";
}
...
<body>
<h1>bachelor of education in sciences</h1>
