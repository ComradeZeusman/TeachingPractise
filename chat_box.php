...
if (isset($_GET['admin_id'])) {
    ...
    $sql = "SELECT * FROM admin_complaint WHERE student_id = $user_id AND admin_id = $admin_id";
    ...
    <body>
        <h1>Chat with <?php echo $admin_name; ?></h1>
    ...
    sendButton.addEventListener("click", function () {
        ...
        xhttp.open("POST", "replyprocess.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
        xhttp.send("user_id=" + user_id + "&admin_id=" + admin_id + "&reply=" + reply);
