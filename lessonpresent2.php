...
if  ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO lesson_presentation2 (student_id, actual_score_introduction, actual_score_pacing, actual_score_teaching_materials, actual_score_teaching_methods, actual_score_questions, actual_score_instruction, actual_score_chalkboard, actual_score_subject_mastery, actual_score_conclusion, actual_score_rapport)
    ...
    if (!$result) {
        ...
        header("Location: evaulation_assessment2.php?id=$id");
    }
